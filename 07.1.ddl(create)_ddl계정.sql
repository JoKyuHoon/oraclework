...
INSERT INTO MEM_UNIQUE3 VALUES(5, 'user05', 'pwd05', '박아름', 'ㄱ', NULL, NULL);
...
INSERT INTO MEM_CHECK VALUES(1, 'user01', 'pwd01', '홍길동', '남', '010-1234-5678', 'asd@naver.com');
INSERT INTO MEM_CHECK VALUES(2, 'user02', 'pwd02', '아아아', '여', '010-1244-5128', 'ah@naver.com');
-- CHECK 제약조건 위배
...
/*
    * PRIMARY KEY(기본키) 제약조건
    ...
    그 컬럼에 NOT NULL + UNIQUE 제약조건 -> 검색, 삭제, 수정
...
CREATE TABLE MEM_PRIMARY (
    MEM_NO NUMBER PRIMARY KEY,
    MEM_ID VARCHAR2(20) PRIMARY KEY -- PRIMARY KEY 는 한개만 가능
);

INSERT INTO MEM_PRIMARY VALUES(1, 'user01', 'pwd01', '홍길동', '남', '010-1234-5678', 'asd@naver.com');
...
CREATE TABLE TB_MULT (
    MEM_NO NUMBER,
    PRODUCT_NAME VARCHAR2(10),
    LIKE_DATE DATE,
    PRIMARY KEY(MEM_NO, PRODUCT_NAME)  -- 두 개를 묶어서 넣으면 가능
    );
...
*/
INSERT INTO TB_MULT VALUES(1, 'A', SYSDATE);
INSERT INTO TB_MULT VALUES(1, 'B', SYSDATE);
INSERT INTO TB_MULT VALUES(2, 'B', SYSDATE);
INSERT INTO TB_MULT VALUES(1, 'B', SYSDATE); --> 오류
...
INSERT INTO MEM_GRADE VALUES(20, '일반회원');
INSERT INTO MEM_GRADE VALUES(30, '일반회원');
...
INSERT INTO MEM VALUES(1, 'user01', 'pwd01', '홍길동', '남', '010-1234-5678', 'asd@naver.com', NULL);
...
INSERT INTO MEM2 VALUES(1, 'user01', 'pwd01', '홍길동', '남', '010-1234-5678', 'asd@naver.com', NULL);
...
-- 데이터 삭제시 : DELETE FROM 테이블명 WHRER 조건;

--> MEM_GRADE 테이블에서 10번등급 삭제
DELETE FROM MEM_GRADE
WHERE GRADE_CODE = 10;
-- 자식 테이블에 10이라는 값을 사용하고 있기 때문에 삭제 불가능
...
INSERT INTO MEMBER2 VALUES(2, 'user02', '나순이', NULL, NULL, NULL);
...
-- EMPLOYEE 테이블 몇개의 컬럼과 연봉의 컬럼이 있는 테이블을 생성
CREATE TABLE EMPLOYEE_COPY3
AS SELECT EMP_NO, EMP_ID, EMP_NAME, SALARY, SALARY*12 연봉 -- 산술식, 함술식이 들어간 컬럼은 반드시 별칭을 부여해야한다
    FROM EMPLOYEE;
...
/*
    * 테이블을 다 생성한 후에 제약조건 추가
    ...
    - PRIMARY KEY : ALTER TABLE 테이블명 ADD PRIMAEY KEY(컬럼명);
    - FOREIGN KEY : ALTER TABLE 테이블명 ADD FORIEGN KEY(컬럼명); REFERENCES 참조할 테이블명[(참조할컬럼명)]
    - UNIQUE : ALTER TABLE 테이블명 ADD UNIQUE(컬럼명)
    - CHECK : ALTER TABLE 테이블명 ADD CHECK(컬럼에 대한 조건식)
    - NOT NULL : ALTER TABLE 테이블명 MODIFY 컬럼명 NOT NULL
*/
-- EMPLOYEE_COPY PRIMARY KEY 추가
ALTER TABLE EMPLOYEE_COPY ADD PRIMARY KEY(EMP_ID);

-- EMPLOYEE_COPY DEPARTMENT 왜래키 추가
ALTER TABLE EMPLOYEE_COPY ADD FOREIGN KEY(DEPT_CODE) REFERENCES DEPARTMENT(DEPT_ID);
--(DEPT_ID)는 생략가능 >> RPIMARY KEY이기 때문에

-- COMMENT 넣기
COMMENT ON COLUMN EMPLOYEE_COPY.EMP_ID IS '회원정보';
